  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: MaterialApp(
        ...
        home: InactiveDeviceCardPage(title: 'Total Devices'),
      ),
    );
  }
}

class InactiveDeviceCardPage extends StatefulWidget {
  InactiveDeviceCardPage({Key key, this.title}) : super(key: key);
  final String title;
