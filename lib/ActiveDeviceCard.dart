...
class ActiveDeviceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    appBar = CustomAppBarBack(context,"Active Devices");
    return GestureDetector(
      ...
      child: MaterialApp(
        ...
        home: ActiveDeviceCardPage(title: 'Total Devices'),
      ),
    );
  }
}

class ActiveDeviceCardPage extends StatefulWidget {
  ActiveDeviceCardPage({Key key, this.title}) : super(key: key);
  final String title;
...
class _ActiveDeviceCard extends State<ActiveDeviceCardPage> {
